...
@# <msg>__rosidl_typesupport_opensplice_c.h files
@#
@# Context:
...
header_guard_parts = [
    ...
    get_header_filename_from_msg_name(spec.base_type.type) + '__rosidl_typesupport_opensplice_c_h']
...
#include "@(spec.base_type.pkg_name)/msg/rosidl_typesupport_opensplice_c__visibility_control.h"
