...
header_guard_parts = [
    spec.pkg_name, 'srv',
    get_header_filename_from_msg_name(spec.srv_name) + '__rosidl_typesupport_opensplice_cpp_hpp']
...
#include "@(spec.pkg_name)/msg/rosidl_typesupport_opensplice_cpp__visibility_control.h"
